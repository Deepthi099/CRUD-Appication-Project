...
Extract the Batch-01-10-CRUD-application-IT-B.zip file

Now open the extracted folder (project) in the VS Code or any IDE
...
In inspect go to network option to view the data stored in the database. There we can verify the data that is stored in the database.
